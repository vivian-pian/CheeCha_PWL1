                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-3 text-center">
                                    <a href="{{ route('pelanggan.edit', $item->id_pelanggan) }}" class="text-primary text-decoration-none me-3">Edit</a>
    
                                    <form action="{{ route('pelanggan.destroy', $item->id_pelanggan) }}" method="POST" class="d-inline">
                                        @csrf 
                                        @method('DELETE')
                                        <button type="submit" class="text-danger border-0 bg-transparent p-0" onclick="return confirm('Are you sure?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
